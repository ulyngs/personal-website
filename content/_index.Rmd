  ...
  column(12, class="featured-category",
      ...
      fluidRow(
        column(6, class="featured-category-description",
               HTML('<p>On online stores for apps and browser extensions, hundreds of apps and browser extensions promise to help us control our time and attention on smartphones and laptops. These \'digital self-control tools\' can block distractions, track device use, remind us of our intentions, gamify our intended use, and more.</p>
        ...
        column(6,
               fluidRow(
                 column(6,
                   ...
                   #tags$img(class="card-img-bottom", src="/post/2019-04-30_367-tools-of-resistance/preview.jpg")),
                 column(6,
                        div(class="card",
                            div(class="card-body",
                                h5(class="card-title",
                                   "Which design patterns actually work?"),
                                HTML('<p class="card-text">In <a href="https://ulriklyngs.com/publications#switch_tube_a_proof_of_concept_system_introducing_adaptable_commitment_interfaces_as_a_tool_for_digital_wellbeing" class="card-link">SwitchTube</a>, we showed the benefits of letting people switch between a search-first and a recommendations-first interface on YouTube. (CHI\'23)</p>
                                ...
                                '))
                            #tags$img(class="card-img-bottom", src="/images/goal-support.png")
                    ))
                  )
               )
      )
...
div(class="main-container container",
    fluidRow(
      ...
      fluidRow(
        column(6,
               HTML('<p>Writing rigorous academic papers is one thing. But what should a person who just wants to find effective solutions <em>do</em>? Academics papers don\'t normally give concrete advice, nor make the tools they build publicly available.</p>
                    <p>To help people control their time and attention on digital devices, I run a workshop that assists people who struggle with digital distraction. I developed the workshop with the incredible Maureen Freed, who formerly was Deputy Head of Counselling at the University of Oxford.</p>
<p>I also develop digital self-control tools for the Safari browser. I originally did this for my personal use, but I shared the apps on the Apple App store and made the code open source.</p>')
          ),
        column(6,
               fluidRow(
                 column(6,
                        div(class="card",
                            div(class="card-body",
                                HTML('<h5 class="card-title">Coaching interventions for digital self-control</h5>
                                     <p class="card-text">My ReDD workshop helps people reflect on their challenges and goals, find the right digital self-control tools to help, and get the support they need to apply them.</p>
...
div(class="main-container container",
    fluidRow(
      ...
      fluidRow(
        column(3,
               HTML('<p>I was exposed to the ‘reproducibility crisis’ early on when I studied psychology, which made me passionate about open, transparent, and reproducible research practices.</p> 
                        ...
                        div(class="card",
                            div(class="card-body",
                                HTML('<h5 class="card-title"><code>oxforddown</code><br>Oxford University Thesis Template for R Markdown</h5>
                                     ...
                                     <p>I open-sourced my template, and it has now been used by hundreds of students.</p>
                                     <p>
                        ...
                        div(class="card",
                            div(class="card-body",
                                HTML('<h5 class="card-title"><code>pagedownCV</code><br>Dynamic CV generation with R Markdown</h5>
                                     ...
                                     <p>I created a tool that automatically generates a CV in different formats based on entries kept in a spreadsheet.</p>
...
featured_videos <- tribble(
  ...
  "https://www.youtube.com/embed/aU0uetWJXis",   "Demo of my workflow for writing reproducible academic papers with R Markdown @ Reproducible Research Oxford, 2021",
  ...
  "https://www.youtube.com/embed/sJf_F7faczU",   "Presenting our analysis of digital self-control tools on the Google Play, Chrome Web, and Apple App stores @ CHI 2019",
  "https://www.youtube.com/embed/2TeIvEunO84",   "Showreel for my live karaoke band. Drop me a line if you want to book us :)"
)
