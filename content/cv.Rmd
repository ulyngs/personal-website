...
<a class="btn btn-light" href="/pdfs/academic_cv.pdf" role="button"><i class="fa fa-download"></i> Download CV as PDF</a>
...
<h2 data-toc-text="Grants">Grants and funding</h2>
```{r}
cv_entries %>% 
