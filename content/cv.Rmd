...
<li class="nav-item">
<a class="nav-link active" data-toggle="tab" href="#media">Media</a>
</li>
<li class="nav-item">
<a class="nav-link" data-toggle="tab" href="#talks">Talks</a>
</li>
<li class="nav-item">
...
# media tab
cat('<div class="tab-pane container active" id="media">')
media_table %>% kable()
cat('</div>')

# talks tab
cat('<div class="tab-pane container fade" id="talks">')
