...
_Note: After I wrote this blog post, helpful folks over at [PsychMAP](https://www.facebook.com/groups/psychmap/) shared some excellent initiatives that address the same issue: [Curate Science](http://curatescience.org) is a crowdsourced collection and annotation of replications, and [Pub Peer](https://pubpeer.com) is a browser plug-in that gives you other researchers' comments on the article you're reading. Check them out!_

Science is in trouble. 
For decades, we have paid lip service to the notion that scientific knowledge can be trusted because it is reproducible. 
...
The causes of the crisis are painfully obvious: 
...
By default, therefore, published work is almost never direct replications of previously published findings, but rather tweaks and extensions thereof (‘conceptual replications’), and data from experiments that didn’t work just aren’t published.  

There used to be good reasons for this system. 
...
#### 3\. We must publish all studies that are conducted with sound methodology.
