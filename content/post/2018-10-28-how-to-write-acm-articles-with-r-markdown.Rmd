...
categories:
  ...
  - reproducibility
  - ACM CHI
teaser: "/post/2018-10-28-how-to-write-acm-articles-with-r-markdown/preview.jpg"
...
image_path <- "/post/2018-10-28-how-to-write-acm-articles-with-r-markdown/"
```
...
```{r, fig.cap="Step 1 files"}
knitr::include_graphics(str_c(image_path, "step1-files.png"), error = FALSE) 
```
...
```{r, fig.cap="Step 1 compiled to pdf"}
knitr::include_graphics(str_c(image_path, "step1-compiled.jpg"), error = FALSE) 
```
...
```{r, fig.cap="Step 2 compiled first page"}
knitr::include_graphics(str_c(image_path, "step2-compiled-page1.jpg"), error = FALSE) 
```

Ok, so title and abstract is plugged in correctly from the YAML header. Let's look at page 2:

```{r, fig.cap="Step 2 compiled second page"}
knitr::include_graphics(str_c(image_path, "step2-compiled-page2.jpg"), error = FALSE) 
```
...
```{r, fig.cap="Step 3 compiled to pdf"}
knitr::include_graphics(str_c(image_path, "step3-compiled.jpg"), error = FALSE) 
```
...
```{r, fig.cap="Step 4: figure in column width"}
knitr::include_graphics(str_c(image_path, "step4-colwidth.jpg"), error = FALSE) 
```
...
```{r, fig.cap="Step 4: figure in full width"}
knitr::include_graphics(str_c(image_path, "step4-two-colwidth.jpg"), error = FALSE) 
```
...
```{r, fig.cap="Step 5: table in column width"}
knitr::include_graphics(str_c(image_path, "step5-colwidth.png"), error = FALSE) 
```
...
```{r, fig.cap="Step 5: table in full width"}
knitr::include_graphics(str_c(image_path, "step5-two-col-width.png"), error = FALSE) 
```
...
```{r, fig.cap="Step 6: referencing figures and tables"}
knitr::include_graphics(str_c(image_path, "step6.png"), error = FALSE) 
```
