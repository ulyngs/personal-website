...
```{r}
knitr::include_graphics(str_c(image_path, "1struggles.png"))
```
...
knitr::include_graphics(str_c(image_path, "2tools.png"))
```
...
knitr::include_graphics(str_c(image_path, "4effort.png"))
```
