...
teaser: "/post/2019-04-30_367-tools-of-resistance/preview.png"
...
```{r}
knitr::include_graphics(str_c(image_path, "1struggles.png"), error = FALSE)
```
...
knitr::include_graphics(str_c(image_path, "2tools.png"), error = FALSE)
```
...
```{r}
knitr::include_graphics(str_c(image_path, "3plot.png"), error = FALSE)
```
...
knitr::include_graphics(str_c(image_path, "4effort.png"), error = FALSE)
```
...
knitr::include_graphics(str_c(image_path, "5eradicator.jpeg"), error = FALSE)
```
...
knitr::include_graphics(str_c(image_path, "6rescue.png"), error = FALSE)
```
...
knitr::include_graphics(str_c(image_path, "7todo.png"), error = FALSE)
```
...
knitr::include_graphics(str_c(image_path, "8reward.png"), error = FALSE)
```
...
knitr::include_graphics(str_c(image_path, "9model.png"), error = FALSE)
```
