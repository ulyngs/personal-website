...
The variable names in your YAML header are arbitrary - they don't have to be something that `pandoc` has seen before.
Let's pull in also the abstract and the author summary, from the R Markdown file, and use silly variable names we make up ourselves:
