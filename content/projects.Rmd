...
#### publications #####
publications <- read_csv(here::here("_data", "publications.csv"))

#### cv entries #####
cv_entries <- read_csv(here::here("_data", "cv_entries.csv"))

#### projects ####
projects <- read_csv(here::here("_data", "projects.csv"))
