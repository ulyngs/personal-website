...
publications_table <- publications %>%
  ...
  mutate(award = case_when(
    !is.na(award) & str_detect(award, "honourable")         ~ str_c("<img src='/images/ribbon_xs.png' style='height: 1em;'><em> ", award, "</em> ·"),
    !is.na(award) ~ str_c("<i class='fa fa-trophy'></i><em> ", award, "</em> ·"),
    TRUE                          ~       ""
  ),
