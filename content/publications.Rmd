...
publications_table <- publications %>%
  ...
  mutate(award = case_when(
    !is.na(award) & str_detect(award, "honourable")         ~ str_c("<img src='/images/ribbon_xs.png' style='height: 1em;'><span class='award-text'> ", award, "</span> ·"),
    !is.na(award) ~ str_c("<i class='fa fa-trophy'></i><span class='award-text'> ", award, "</span> ·"),
    TRUE                          ~       ""
  ),
  ...
  abstract_btn = ifelse(is.na(abstract), "", 
                    str_c(" · <span class='abstract-toggle collapsed' data-toggle='collapse' href='#", abstract_id, "' aria-expanded='false' aria-controls='", abstract_id, "'>abstract <i class='fa' aria-hidden='true'></i></span>")),
  ...
  mutate(citation = str_c("<a class='anchor' id='", anchor, "'></a>",
         ...
         citation = str_c("<div>", 
                          ...
                          award, pdf, materials, ebook, blog, full_talk, bibtex, abstract_btn,
                          "</div>",
                          abstract_collapse,
                          sep = "")
           ) %>% 
